...
class Tikitool < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/bcpitutor/gobase/releases/download/v1.0.12/tikitool_darwin_arm64"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/bcpitutor/gobase/releases/download/v1.0.12/tikitool_darwin_amd64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bcpitutor/gobase/releases/download/v1.0.12/tikitool_linux_amd64"
